...
1. Add `https://raw.githubusercontent.com/tlcsdm/eclipse-generateAllSetter/update_site/` as the upgrade location in Eclipse.
  ...
  <tbody>
    <tr style="border:none;">
      <td style="vertical-align: middle; padding-top: 10px; border: none;">
        <a href='http://marketplace.eclipse.org/marketplace-client-intro?mpc_install=7229780' title='Drag and drop into a running Eclipse Indigo workspace to install eclipse-generateAllSetter'> 
